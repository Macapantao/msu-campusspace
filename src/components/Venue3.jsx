...
import venueImage1 from "../images/icc.png"; // Update with appropriate image
import venueImage2 from "../images/icc1.jpg"; // Update with appropriate image
...
const Venue3 = () => {
  ...
  return (
    <div className="p-8 bg-white">
      <h2 className="text-4xl font-bold text-black mb-6 text-center">INTERNATIONAL CONVENTION CENTER</h2>
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        <div className="flex-1">
          <div className="bg-gray-100 p-6 rounded-lg shadow-md">
            ...
            <p className="text-xl mt-1"><strong>Location:</strong> 2nd Street, MSU</p>
            <p className="text-xl mt-1"><strong>Type:</strong> Community & Public Events</p>
            <p className="text-xl mt-1">
              <strong>Rating:</strong>
              <FaStar className="inline text-gold mx-1" /> 4.8
            </p>
            <p className="mt-4 text-xl">
              <strong>Description:</strong> The International Convention Center is an ideal venue for large public events, conventions, conferences, and seminars. It provides a spacious and modern setting for your events.
            </p>
            <p className="text-xl mt-1"><strong>Capacity:</strong> 500-1000 people</p>
        ...
        <div className="flex-1 bg-gray-100 p-6 rounded-lg shadow-md">
          ...
          <div className="mt-8">
            ...
            <p className="text-xl mt-2">
              <strong>Email:</strong> events@iccvenue.com
            </p>
            <p className="text-xl mt-1">
              <strong>Phone:</strong> +63 932 123 4567
            </p>
