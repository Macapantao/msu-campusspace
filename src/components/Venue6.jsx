...
import venueImage2 from "../images/cakeko2.jpg"; // Update with appropriate image
import venueImage3 from "../images/cakeko3.jpg"; // Update with appropriate image
...
const Venue6 = () => {
  ...
  return (
    <div className="p-8 bg-white">
      <h2 className="text-4xl font-bold text-black mb-6 text-center">CAKE KO RESTAURANT</h2>
      
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
        <img src={venueImage2} alt="Venue" className="w-full h-96 object-cover rounded-lg" />
        <img src={venueImage3} alt="Venue" className="w-full h-96 object-cover rounded-lg" />
      </div>
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        <div className="flex-1">
          <div className="bg-gray-100 p-6 rounded-lg shadow-md">
            ...
            <p className="text-xl mt-1"><strong>Location:</strong>MSU Campus</p>
            <p className="text-xl mt-1"><strong>Type:</strong> Social Gatherings and Celebrations</p>
            <p className="text-xl mt-1">
              <strong>Rating:</strong>
              <FaStar className="inline text-gold mx-1" /> 4.9
            </p>
            <p className="mt-4 text-xl">
            <strong>Description:</strong> Cake Ko Restaurant is the ideal venue for occasions like birthdays, meetings, graduation celebrations, and other special events. It offers a cozy and elegant atmosphere, making it perfect for both intimate gatherings and larger social events.
            </p>
            <p className="text-xl mt-1"><strong>Capacity:</strong> 500-800 people</p>
            <p className="text-xl mt-1"><strong>Available Times:</strong> 9:00 AM - 12:00 AM</p>
          </div>
        </div>
        ...
        <div className="flex-1 bg-gray-100 p-6 rounded-lg shadow-md">
          ...
          <div className="mt-8">
            ...
            <p className="text-xl mt-2">
              <strong>Email:</strong> sunset@msuvenue.com
            </p>
            <p className="text-xl mt-1">
              <strong>Phone:</strong> +63 915 123 4567
            </p>
